...
// import DrawerDefault from "../Component/SideNav"
...
export const TaskHome = ()=>{
    ...
    return(
        <div className="flex flex-col">
            ...
            <div className="flex ">
                <div className="bg-blue-500 w-[25%] mx-w-xl hidden lg:block">
                    <SideNav/>
                </div>
    
                
                <div className="space-y-2 flex lg:pt-4  justify-center mx-auto flex-1  max-w-xl   h-screen lg:h-full w-full bg-cover flex-col">
